    ...
    if (settingsPage === "appearance") {
      ...
      pageContent = h(React.Fragment, null,
        ...
        Group(null, h("div", { className: "settings-plain-info" },
          ...
          h("div", null, h("span", null, "Version"), h("strong", null, "1.0.60 · Personal prototype")),
      ...
      pageContent = h(React.Fragment, null,
        ...
        Group(null, [
          h(NavRow, { key: "about", icon: Icons.IconInfo, title: "About AleemFin", value: "1.0.60", onClick: () => setSettingsPage("about") })
        ]),
        Group(null, [
