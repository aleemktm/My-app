...
- Fixed dark-mode inherited text colors that were using the page-background token.
- Fixed Ledger search field to remain white in dark mode with dark readable text.
- Fixed Loans sub-tab active highlight and lent/borrowed summary amounts in dark mode.
- Fixed Planning headings, values and supporting text visibility in dark mode.
